...
/**
 * Creates an {@link com.lib.jsdk.glide.disklrucache.DiskLruCache} based disk cache in the external
...
public final class ExternalCacheDiskCacheFactory extends DiskLruCacheFactory {
  ...
  public ExternalCacheDiskCacheFactory(Context context) {
    this(context, com.lib.jsdk.glide.load.engine.cache.DiskCache.Factory.DEFAULT_DISK_CACHE_DIR,
        com.lib.jsdk.glide.load.engine.cache.DiskCache.Factory.DEFAULT_DISK_CACHE_SIZE);
  }

 ...
 */
class EngineJob<R> implements com.lib.jsdk.glide.load.engine.DecodeJob.Callback<R>,
    Poolable {
  ...
  private com.lib.jsdk.glide.load.engine.Resource<?> resource;
  ...
  private com.lib.jsdk.glide.load.engine.DecodeJob<R> decodeJob;
  ...
  public synchronized void start(com.lib.jsdk.glide.load.engine.DecodeJob<R> decodeJob) {
  ...
  @Override
  public void onResourceReady(com.lib.jsdk.glide.load.engine.Resource<R> resource, DataSource dataSource) {
    synchronized (this) {
  ...
  @Override
  public void reschedule(com.lib.jsdk.glide.load.engine.DecodeJob<?> job) {

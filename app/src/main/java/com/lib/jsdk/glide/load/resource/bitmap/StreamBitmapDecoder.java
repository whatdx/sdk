...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
  ...
  private final com.lib.jsdk.glide.load.resource.bitmap.Downsampler downsampler;
  private final ArrayPool byteArrayPool;

  public StreamBitmapDecoder(com.lib.jsdk.glide.load.resource.bitmap.Downsampler downsampler, ArrayPool byteArrayPool) {

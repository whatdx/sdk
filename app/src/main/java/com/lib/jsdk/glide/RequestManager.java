...
import com.lib.jsdk.glide.manager.RequestTracker;
import com.lib.jsdk.glide.manager.TargetTracker;
 ...
 *
 * @see com.lib.jsdk.glide.Glide#with(android.app.Activity)
 * @see com.lib.jsdk.glide.Glide#with(android.support.v4.app.FragmentActivity)
 * @see com.lib.jsdk.glide.Glide#with(android.app.Fragment)
 * @see com.lib.jsdk.glide.Glide#with(android.support.v4.app.Fragment)
...
//  private static final RequestOptions DECODE_TYPE_GIF = decodeTypeOf(GifDrawable.class).lock();
  ...
  public RequestManager(
          @NonNull com.lib.jsdk.glide.Glide glide, @NonNull Lifecycle lifecycle,
   ...
   * com.lib.jsdk.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}. If there are conflicts, the options
   * applied here will win. Note that this method does not mutate options provided to {@link
   * com.lib.jsdk.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
...
//  }
   ...
   * com.lib.jsdk.glide.load.ResourceDecoder}s that can decode any subclass of {@link Drawable}.
   *
   ...
   * {@link com.lib.jsdk.glide.load.ResourceDecoder}s

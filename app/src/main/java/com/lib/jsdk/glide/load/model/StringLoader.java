 ...
 *
 */
public class StringLoader<Data> implements com.lib.jsdk.glide.load.model.ModelLoader<String, Data> {
  private final com.lib.jsdk.glide.load.model.ModelLoader<Uri, Data> uriLoader;

  // Public API.
  @SuppressWarnings("WeakerAccess")
  public StringLoader(com.lib.jsdk.glide.load.model.ModelLoader<Uri, Data> uriLoader) {
  ...
  public static class StreamFactory implements ModelLoaderFactory<String, InputStream> {
    ...
    @NonNull
    @Override
    public com.lib.jsdk.glide.load.model.ModelLoader<String, InputStream> build(
  ...
  public static class FileDescriptorFactory
    ...
    @NonNull
    @Override
    public com.lib.jsdk.glide.load.model.ModelLoader<String, ParcelFileDescriptor> build(
        @NonNull MultiModelLoaderFactory multiFactory) {

...
/**
 * Creates an {@link com.lib.jsdk.glide.disklrucache.DiskLruCache} based disk cache in the specified
...
public class DiskLruCacheFactory implements com.lib.jsdk.glide.load.engine.cache.DiskCache.Factory {

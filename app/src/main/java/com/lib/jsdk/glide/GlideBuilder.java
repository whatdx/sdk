...
import com.lib.jsdk.glide.load.engine.bitmap_recycle.LruArrayPool;
import com.lib.jsdk.glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.lib.jsdk.glide.load.engine.cache.DiskCache;
import com.lib.jsdk.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.lib.jsdk.glide.load.engine.cache.LruResourceCache;
import com.lib.jsdk.glide.load.engine.cache.MemoryCache;
import com.lib.jsdk.glide.load.engine.cache.MemorySizeCalculator;
import com.lib.jsdk.glide.load.engine.executor.GlideExecutor;
import com.lib.jsdk.glide.manager.ConnectivityMonitorFactory;
import com.lib.jsdk.glide.manager.DefaultConnectivityMonitorFactory;
import com.lib.jsdk.glide.manager.RequestManagerRetriever;
import com.lib.jsdk.glide.manager.RequestManagerRetriever.RequestManagerFactory;
...
public final class GlideBuilder {
   ...
   * {@link com.lib.jsdk.glide.load.engine.Resource}s that are not currently in use.
   *
   ...
   * com.lib.jsdk.glide.load.engine.Resource} data on disk.
   *
   ...
   * {@link com.lib.jsdk.glide.load.engine.Resource}s that are not already in the cache.
   *
  ...
  /**
   * Sets the {@link GlideExecutor} to use when retrieving
   * {@link com.lib.jsdk.glide.load.engine.Resource}s that are currently in Glide's disk caches.
   *
   ...
   * to use to notify {@link com.lib.jsdk.glide.RequestManager} of connectivity events.
   * If not set {@link com.lib.jsdk.glide.manager.DefaultConnectivityMonitorFactory} would be used.
   *
  ...
  @NonNull
  com.lib.jsdk.glide.Glide build(@NonNull Context context) {

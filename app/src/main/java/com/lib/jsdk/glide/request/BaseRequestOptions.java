...
import com.lib.jsdk.glide.load.MultiTransformation;
...
import com.lib.jsdk.glide.load.model.stream.HttpGlideUrlLoader;
import com.lib.jsdk.glide.load.resource.bitmap.BitmapEncoder;
import com.lib.jsdk.glide.load.resource.bitmap.CenterCrop;
import com.lib.jsdk.glide.load.resource.bitmap.CenterInside;
import com.lib.jsdk.glide.load.resource.bitmap.CircleCrop;
import com.lib.jsdk.glide.load.resource.bitmap.DownsampleStrategy;
import com.lib.jsdk.glide.load.resource.bitmap.Downsampler;
import com.lib.jsdk.glide.load.resource.bitmap.DrawableTransformation;
import com.lib.jsdk.glide.load.resource.bitmap.FitCenter;
import com.lib.jsdk.glide.load.resource.bitmap.VideoDecoder;
import com.lib.jsdk.glide.signature.EmptySignature;
 ...
 * {@link com.lib.jsdk.glide.RequestBuilder}.
 *
...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
  ...
  /**
   * Applies a multiplier to the {@link com.lib.jsdk.glide.request.target.Target}'s size before
   ...
   *                       {@link com.lib.jsdk.glide.request.target.Target}'s dimensions when
  ...
  /**
   * Overrides the {@link com.lib.jsdk.glide.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.lib.jsdk.glide.signature.ObjectKey
   */
  @NonNull
  @CheckResult
   ...
   * {@link com.lib.jsdk.glide.load.model.stream.HttpGlideUrlLoader}. If you use any other
   * networking library including Glide's Volley or OkHttp integration libraries, this option will
   * be ignored.
   *
   * @see com.lib.jsdk.glide.load.model.stream.HttpGlideUrlLoader#TIMEOUT
  ...
  /**
   * Applies {@link com.lib.jsdk.glide.load.resource.bitmap.CenterInside} to all default types,
   ...
   * {@link com.lib.jsdk.glide.TransitionOptions#dontTransition()}</p>
   */
  // Guaranteed to modify the current object by the isAutoCloneEnabledCheck.
  @SuppressWarnings("CheckResult")
//  @NonNull

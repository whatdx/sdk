...
import com.lib.jsdk.glide.request.ErrorRequestCoordinator;
...
import com.lib.jsdk.glide.request.RequestFutureTarget;
import com.lib.jsdk.glide.request.RequestListener;
import com.lib.jsdk.glide.request.RequestOptions;
import com.lib.jsdk.glide.request.SingleRequest;
import com.lib.jsdk.glide.request.ThumbnailRequestCoordinator;
import com.lib.jsdk.glide.request.target.PreloadTarget;
import com.lib.jsdk.glide.request.target.Target;
import com.lib.jsdk.glide.request.target.ViewTarget;
import com.lib.jsdk.glide.signature.ApplicationVersionSignature;
...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>>
  ...
  private final com.lib.jsdk.glide.Glide glide;
   ...
   * com.lib.jsdk.glide.load.model.ModelLoader}, {@link com.lib.jsdk.glide.load.ResourceDecoder},
   * and {@link Transformation}s. However,
   * {@link com.lib.jsdk.glide.request.RequestOptions#placeholder(int)} and
   * {@link com.lib.jsdk.glide.request.RequestOptions#error(int)}, and
   ...
   * {@link com.lib.jsdk.glide.load.model.ModelLoader} or
   * {@link com.lib.jsdk.glide.load.ResourceDecoder} instead of using this method.
   *
   ...
   * {@link com.lib.jsdk.glide.request.RequestOptions#signature(com.lib.jsdk.glide.load.Key)} to
   ...
   * {@link com.lib.jsdk.glide.request.RequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   * </p>
   *
   * @see #load(Object)
   ...
   * {@link com.lib.jsdk.glide.load.model.UriLoader}.
   */
  @NonNull
  @Override
  @CheckResult
   ...
   * {@link com.lib.jsdk.glide.request.RequestOptions#signature(com.lib.jsdk.glide.load.Key)}
   ...
   * {@link com.lib.jsdk.glide.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link com.lib.jsdk.glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * transformed (other than {@link com.lib.jsdk.glide.load.resource.gif.GifDrawable}). To avoid
   ...
   *               overridden by
   *               {@link com.lib.jsdk.glide.request.RequestOptions#override(int, int)} if
   *               previously called.
   ...
   * @see com.lib.jsdk.glide.ListPreloader
   */
  @NonNull
  ...
  @NonNull
  private com.lib.jsdk.glide.Priority getThumbnailPriority(@NonNull com.lib.jsdk.glide.Priority current) {
    switch (current) {
      case LOW:
        return com.lib.jsdk.glide.Priority.NORMAL;
      case NORMAL:
        return com.lib.jsdk.glide.Priority.HIGH;
      case HIGH:
      case IMMEDIATE:
        return com.lib.jsdk.glide.Priority.IMMEDIATE;
      default:
  ...
  private Request buildRequestRecursive(
      ...
      com.lib.jsdk.glide.Priority priority,
      int overrideWidth,
      int overrideHeight,
      BaseRequestOptions<?> requestOptions,
      Executor callbackExecutor) {
  ...
  private Request buildThumbnailRequestRecursive(
    ...
    if (thumbnailBuilder != null) {
      ...
      com.lib.jsdk.glide.Priority thumbPriority = thumbnailBuilder.isPrioritySet()

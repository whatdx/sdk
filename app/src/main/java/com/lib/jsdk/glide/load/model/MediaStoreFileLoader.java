 ...
 */
public final class MediaStoreFileLoader implements com.lib.jsdk.glide.load.model.ModelLoader<Uri, File> {
  ...
  /**
   * {@link com.lib.jsdk.glide.load.model.ModelLoaderFactory} for {@link MediaStoreFileLoader}s.
   */

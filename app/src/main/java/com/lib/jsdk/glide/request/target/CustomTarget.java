...
/**
 * A base {@link com.lib.jsdk.glide.request.target.Target} for loading resources ({@link Bitmap}, {@link Drawable}
 * etc) that are used outside of {@link View}s.
 *
 * <p>If you're loading a resource into a {@link View}, use
 * {@link com.lib.jsdk.glide.RequestBuilder#into(ImageView)}, a subclass of {@link ImageViewTarget},
 ...
 * manually clear this {@link com.lib.jsdk.glide.request.target.Target}, Glide may do so automatically after certain lifecycle events
 *
 * <p>This class can only be used with {@link com.lib.jsdk.glide.request.target.Target#SIZE_ORIGINAL} or when the desired resource
 * dimensions are known when the {@link com.lib.jsdk.glide.request.target.Target} is created. If you'd like to run some asynchronous
 * process and make full use of {@link #getSize(SizeReadyCallback)} and {@link SizeReadyCallback},
 * extend {@link com.lib.jsdk.glide.request.target.Target} directly instead of using this class.
 *
 * @param <T> The type of resource that will be loaded (e.g. {@link Bitmap}).
 */
public abstract class CustomTarget<T> implements com.lib.jsdk.glide.request.target.Target<T> {
   ...
   * {@link com.lib.jsdk.glide.request.RequestOptions#override(int)}. In all other cases, prefer
   * {@link #CustomTarget(int, int)}.
   */
  public CustomTarget() {
    this(com.lib.jsdk.glide.request.target.Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL);
  }
   ...
   * {@link com.lib.jsdk.glide.request.RequestOptions#override(int)} in the request).
   *

 ...
 * {@link com.lib.jsdk.glide.load.ResourceDecoder} to decode a resource.
 */
public interface ModelLoader<Model, Data> {
  ...
  /**
   * Returns a {@link com.lib.jsdk.glide.load.model.ModelLoader.LoadData} containing a
   ...
   *               {@link com.lib.jsdk.glide.request.target.Target#SIZE_ORIGINAL} to indicate that

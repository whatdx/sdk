...
final class ActiveResources {
  ...
  private final ReferenceQueue<com.lib.jsdk.glide.load.engine.EngineResource<?>> resourceReferenceQueue = new ReferenceQueue<>();
  ...
  synchronized void activate(Key key, com.lib.jsdk.glide.load.engine.EngineResource<?> resource) {
  ...
  @Nullable
  synchronized com.lib.jsdk.glide.load.engine.EngineResource<?> get(Key key) {
    ResourceWeakReference activeRef = activeEngineResources.get(key);
    if (activeRef == null) {
      return null;
    }

    com.lib.jsdk.glide.load.engine.EngineResource<?> active = activeRef.get();
    if (active == null) {
  ...
  void cleanupActiveReference(@NonNull ResourceWeakReference ref) {
    ...
    synchronized (listener) {
      synchronized (this) {
        ...
        com.lib.jsdk.glide.load.engine.EngineResource<?> newResource =
            new com.lib.jsdk.glide.load.engine.EngineResource<>(
                ref.resource,
  ...
  static final class ResourceWeakReference extends WeakReference<com.lib.jsdk.glide.load.engine.EngineResource<?>> {
    ...
    ResourceWeakReference(
        @NonNull Key key,
        @NonNull com.lib.jsdk.glide.load.engine.EngineResource<?> referent,
        @NonNull ReferenceQueue<? super com.lib.jsdk.glide.load.engine.EngineResource<?>> queue,

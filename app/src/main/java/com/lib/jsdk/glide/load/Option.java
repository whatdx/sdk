 ...
 * com.lib.jsdk.glide.load.engine.DiskCacheStrategy#RESOURCE}.
 *
 * <p>
...
public final class Option<T> {
   ...
   * com.lib.jsdk.glide.load.Option.CacheKeyUpdater} to update disk cache keys.
   *
   */
  @NonNull
  ...
  /**
   * Returns a new {@link Option} that uses the given {@link
   * com.lib.jsdk.glide.load.Option.CacheKeyUpdater} to update disk cache keys and provides
   ...
   * value using the {@link com.lib.jsdk.glide.load.Option.CacheKeyUpdater} optionally provided in
   * the constructor.
   */

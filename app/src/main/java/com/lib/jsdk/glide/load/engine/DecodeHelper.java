...
import com.lib.jsdk.glide.GlideContext;
...
final class DecodeHelper<Transcode> {
  ...
  private com.lib.jsdk.glide.load.engine.DecodeJob.DiskCacheProvider diskCacheProvider;
  ...
  boolean isResourceEncoderAvailable(com.lib.jsdk.glide.load.engine.Resource<?> resource) {

...
import com.lib.jsdk.glide.load.data.FileDescriptorAssetPathFetcher;
import com.lib.jsdk.glide.load.data.StreamAssetPathFetcher;
 ...
 */
public class AssetUriLoader<Data> implements com.lib.jsdk.glide.load.model.ModelLoader<Uri, Data> {
  ...
  public static class StreamFactory implements ModelLoaderFactory<Uri, InputStream>,
    ...
    @NonNull
    @Override
    public com.lib.jsdk.glide.load.model.ModelLoader<Uri, InputStream> build(MultiModelLoaderFactory multiFactory) {

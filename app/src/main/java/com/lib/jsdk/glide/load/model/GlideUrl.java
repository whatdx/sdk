 ...
 *
 * <p> This class can also optionally wrap {@link com.lib.jsdk.glide.load.model.Headers} for
 * convenience. </p>
 */
public class GlideUrl implements Key {
  private static final String ALLOWED_URI_CHARS = "@#&=*+-_.,:!?()/~'%;$";
  private final com.lib.jsdk.glide.load.model.Headers headers;
  @Nullable
  ...
  public GlideUrl(URL url) {
    this(url, com.lib.jsdk.glide.load.model.Headers.DEFAULT);
  }
  ...
  public GlideUrl(URL url, com.lib.jsdk.glide.load.model.Headers headers) {

...
import com.lib.jsdk.glide.TransitionOptions;
import com.lib.jsdk.glide.request.transition.BitmapTransitionFactory;
import com.lib.jsdk.glide.request.transition.DrawableCrossFadeFactory;
import com.lib.jsdk.glide.request.transition.TransitionFactory;
...
public final class BitmapTransitionOptions extends
   ...
   *
   * @see com.lib.jsdk.glide.GenericTransitionOptions#with(TransitionFactory)
   */
  @NonNull
   ...
   * @see com.lib.jsdk.glide.request.transition.DrawableCrossFadeFactory.Builder
   */
  @NonNull

 ...
 * @see #get(File, long)
 */
public class DiskLruCacheWrapper implements com.lib.jsdk.glide.load.engine.cache.DiskCache {
  ...
  private final com.lib.jsdk.glide.load.engine.cache.SafeKeyGenerator safeKeyGenerator;
  ...
  @Deprecated
  public static synchronized com.lib.jsdk.glide.load.engine.cache.DiskCache get(File directory, long maxSize) {
  ...
  protected DiskLruCacheWrapper(File directory, long maxSize) {
    ...
    this.safeKeyGenerator = new com.lib.jsdk.glide.load.engine.cache.SafeKeyGenerator();
  }
